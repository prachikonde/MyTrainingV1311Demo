...
using MyTrainingV1311Demo.MultiTenancy.HostDashboard;
...
namespace MyTrainingV1311Demo.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(MyTrainingV1311DemoDbContext context, SubscriptionPayment subscriptionPayment)
        {
