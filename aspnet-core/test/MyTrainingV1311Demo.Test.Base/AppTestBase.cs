...
using MyTrainingV1311Demo.Test.Base.TestData;
...
namespace MyTrainingV1311Demo.Test.Base
{
    ...
    /// Provides methods to easily work with <see cref="MyTrainingV1311DemoDbContext"/>.
    /// </summary>
    public abstract class AppTestBase<T> : AbpIntegratedTestBase<T> where T : AbpModule
    {
        ...
        {
            void NormalizeDbContext(MyTrainingV1311DemoDbContext context)
            {
        ...
        protected void UsingDbContext(Action<MyTrainingV1311DemoDbContext> action)
        {
            UsingDbContext(AbpSession.TenantId, action);
        }

        protected Task UsingDbContextAsync(Func<MyTrainingV1311DemoDbContext, Task> action)
        {
            return UsingDbContextAsync(AbpSession.TenantId, action);
        }

        protected TResult UsingDbContext<TResult>(Func<MyTrainingV1311DemoDbContext, TResult> func)
        {
            return UsingDbContext(AbpSession.TenantId, func);
        }

        protected Task<TResult> UsingDbContextAsync<TResult>(Func<MyTrainingV1311DemoDbContext, Task<TResult>> func)
        {
            return UsingDbContextAsync(AbpSession.TenantId, func);
        }

        protected void UsingDbContext(int? tenantId, Action<MyTrainingV1311DemoDbContext> action)
        {
            using (UsingTenantId(tenantId))
            {
                using (var context = LocalIocManager.Resolve<MyTrainingV1311DemoDbContext>())
                {
                    action(context);
                    context.SaveChanges();
                }
        ...
        protected async Task UsingDbContextAsync(int? tenantId, Func<MyTrainingV1311DemoDbContext, Task> action)
        {
            using (UsingTenantId(tenantId))
            {
                using (var context = LocalIocManager.Resolve<MyTrainingV1311DemoDbContext>())
        ...
        protected TResult UsingDbContext<TResult>(int? tenantId, Func<MyTrainingV1311DemoDbContext, TResult> func)
        {
            TResult result;
        ...
        protected async Task<TResult> UsingDbContextAsync<TResult>(int? tenantId, Func<MyTrainingV1311DemoDbContext, Task<TResult>> func)
        {
            TResult result;
