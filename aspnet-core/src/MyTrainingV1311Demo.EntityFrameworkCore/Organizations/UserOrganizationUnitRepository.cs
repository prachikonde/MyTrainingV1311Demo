...
namespace MyTrainingV1311Demo.Organizations
{
    public class UserOrganizationUnitRepository : MyTrainingV1311DemoRepositoryBase<UserOrganizationUnit, long>,
        IUserOrganizationUnitRepository
    {
        public UserOrganizationUnitRepository(IDbContextProvider<MyTrainingV1311DemoDbContext> dbContextProvider)
