...
namespace MyTrainingV1311Demo.OpenIddict.Authorizations
{
    public class EfCoreOpenIddictAuthorizationRepository : MyTrainingV1311DemoRepositoryBase<OpenIddictAuthorization, Guid>,
