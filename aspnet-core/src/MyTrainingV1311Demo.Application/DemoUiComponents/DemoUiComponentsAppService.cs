...
using MyTrainingV1311Demo.DemoUiComponents.Dto;

namespace MyTrainingV1311Demo.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : MyTrainingV1311DemoAppServiceBase, IDemoUiComponentsAppService
    {
