...
using MiniExcelLibs;
using MyTrainingV1311Demo.Authorization.Permissions;
...
using MyTrainingV1311Demo.Authorization.Users.Exporting;
using MyTrainingV1311Demo.Dto;
using MyTrainingV1311Demo.Exporting;
...
namespace MyTrainingV1311Demo.Authorization.Users
{
    ...
    public class UserAppService : MyTrainingV1311DemoAppServiceBase, IUserAppService
    {
