...
using MyTrainingV1311Demo.Authorization.Users.Profile.Cache;
...
using MyTrainingV1311Demo.Gdpr;
using MyTrainingV1311Demo.Net.Sms;
using MyTrainingV1311Demo.Security;
using MyTrainingV1311Demo.Storage;
using MyTrainingV1311Demo.Timing;
using MyTrainingV1311Demo.Url;

namespace MyTrainingV1311Demo.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : MyTrainingV1311DemoAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("MyTrainingV1311Demo",
