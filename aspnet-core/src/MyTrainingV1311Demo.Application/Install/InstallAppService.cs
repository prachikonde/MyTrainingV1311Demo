...
using MyTrainingV1311Demo.Migrations.Seed.Host;
...
namespace MyTrainingV1311Demo.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : MyTrainingV1311DemoAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<MyTrainingV1311DemoDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{MyTrainingV1311DemoConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{MyTrainingV1311DemoConsts.ConnectionStringName}", constring);
        }
