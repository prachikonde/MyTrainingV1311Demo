...
using MyTrainingV1311Demo.Auditing.Exporting;
...
using EntityHistoryHelper = MyTrainingV1311Demo.EntityHistory.EntityHistoryHelper;

namespace MyTrainingV1311Demo.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : MyTrainingV1311DemoAppServiceBase, IAuditLogAppService
    {
