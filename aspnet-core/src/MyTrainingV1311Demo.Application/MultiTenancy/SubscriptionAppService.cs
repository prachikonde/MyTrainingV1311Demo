...
{
    public class SubscriptionAppService : MyTrainingV1311DemoAppServiceBase, ISubscriptionAppService
    {
        ...
        {
            return upgradeAmount < MyTrainingV1311DemoConsts.MinimumUpgradePaymentAmount;
        }
