...
using MyTrainingV1311Demo.MultiTenancy.Payments.Stripe;
using MyTrainingV1311Demo.MultiTenancy.Payments.Stripe.Dto;
using Stripe.Checkout;

namespace MyTrainingV1311Demo.MultiTenancy.Payments
{
    public class StripePaymentAppService : MyTrainingV1311DemoAppServiceBase, IStripePaymentAppService
    {
                    ...
                    .Select(p => new SessionLineItemOptions
                    {
                        ...
                        PriceData = new SessionLineItemPriceDataOptions
                        {
                            ...
                            ProductData = new SessionLineItemPriceDataProductDataOptions
                            {
                                ...
                                Name = MyTrainingV1311DemoConsts.ProductName
                            }
                        }
                    }).ToList();
            }
