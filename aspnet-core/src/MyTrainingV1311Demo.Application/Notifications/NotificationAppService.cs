...
using MyTrainingV1311Demo.Notifications.Dto;
using MyTrainingV1311Demo.Organizations;

namespace MyTrainingV1311Demo.Notifications
{
    [AbpAuthorize]
    public class NotificationAppService : MyTrainingV1311DemoAppServiceBase, INotificationAppService
    {
