...
{
    public class SessionAppService : MyTrainingV1311DemoAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = MyTrainingV1311DemoConsts.Currency,
                        CurrencySign = MyTrainingV1311DemoConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = MyTrainingV1311DemoConsts.AllowTenantsToChangeEmailSettings,
