...
using MyTrainingV1311Demo.Authentication.TwoFactor;
...
using MyTrainingV1311Demo.Web.Authentication.JwtBearer;
using MyTrainingV1311Demo.Web.Authentication.TwoFactor;
using MyTrainingV1311Demo.Web.Models.TokenAuth;
using MyTrainingV1311Demo.Authorization.Impersonation;
using MyTrainingV1311Demo.Authorization.Roles;
using MyTrainingV1311Demo.Configuration;
using MyTrainingV1311Demo.Identity;
using MyTrainingV1311Demo.Net.Sms;
using MyTrainingV1311Demo.Notifications;
using MyTrainingV1311Demo.Security.Recaptcha;
using MyTrainingV1311Demo.Web.Authentication.External;
...
namespace MyTrainingV1311Demo.Web.Controllers
{
    ...
    public class TokenAuthController : MyTrainingV1311DemoControllerBase
    {
        ...
        private async Task<string> EncryptQueryParameters(long userId, Tenant tenant, string passwordResetCode)
        {
            ...
            var expireDate = Uri.EscapeDataString(Clock.Now.AddHours(expirationHours)
                .ToString(MyTrainingV1311DemoConsts.DateTimeOffsetFormat));
