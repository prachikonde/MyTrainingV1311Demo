...
/// </summary>
public static class MyTrainingV1311DemoJwtBearerExtensions
{
    /// <summary>
    ...
    public static AuthenticationBuilder AddAbpAsyncJwtBearer(this AuthenticationBuilder builder, string authenticationScheme, string? displayName, Action<AsyncJwtBearerOptions> configureOptions)
    {
        ...
        return builder.AddScheme<AsyncJwtBearerOptions, MyTrainingV1311DemoAsyncJwtBearerHandler>(authenticationScheme, displayName, configureOptions);
    }
}
