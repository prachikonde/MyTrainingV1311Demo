...
using MyTrainingV1311Demo.Web.OpenIddict.Claims;
using MyTrainingV1311Demo.Web.OpenIddict.ViewModels.Authorize;
using OpenIddict.Abstractions;
using OpenIddict.Server.AspNetCore;

namespace MyTrainingV1311Demo.Web.OpenIddict.Controllers
{
