...
namespace MyTrainingV1311Demo.Web.Security.Recaptcha
{
    public class RecaptchaValidator : MyTrainingV1311DemoServiceBase, IRecaptchaValidator, ITransientDependency
    {
