...
using MyTrainingV1311Demo.Mobile.MAUI.Services.Tenants;
using MyTrainingV1311Demo.Mobile.MAUI.Helpers;

#if ANDROID
using MyTrainingV1311Demo.Mobile.MAUI.Platforms.Android.HttpClient;
#endif

namespace MyTrainingV1311Demo.Mobile.MAUI.Shared.Layout
{
...
#elif IOS
            var abpHttpClientFactory = new MyTrainingV1311Demo.Mobile.MAUI.Platforms.iOS.iOSHttpClientFactory
            {
                OnSessionTimeOut = App.OnSessionTimeout,
                OnAccessTokenRefresh = App.OnAccessTokenRefresh
            };
