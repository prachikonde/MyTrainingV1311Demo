...
{
    public class MyTrainingV1311DemoConsts
    {
        public const string LocalizationSourceName = "MyTrainingV1311Demo";
        
        /// <summary>
        /// Name of the product if the app itself is sold as a SAAS product.
        /// </summary>
        public const string ProductName = "MyTrainingV1311Demo";
