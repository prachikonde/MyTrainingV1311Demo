...
using MyTrainingV1311Demo.Authentication;
using MyTrainingV1311Demo.DashboardCustomization;
...
namespace MyTrainingV1311Demo.Configuration
{
    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        {
            if (!MyTrainingV1311DemoConsts.AllowTenantsToChangeEmailSettings)
            {
            ...
            return new[]
            {
                ...
                new SettingDefinition(AppSettings.Email.UseHostDefaultEmailSettings,
                    GetFromAppSettings(AppSettings.Email.UseHostDefaultEmailSettings,
                        MyTrainingV1311DemoConsts.MultiTenancyEnabled ? "true" : "false"), scopes: SettingScopes.Tenant)
            };
        }
        ...
        private IEnumerable<SettingDefinition> GetDashboardSettings()
        {
            ...
            return new[]
            {
                new SettingDefinition(
                    GetSettingName(
                        MyTrainingV1311DemoDashboardCustomizationConsts.Applications.Mvc,
                ...
                new SettingDefinition(
                    GetSettingName(
                        MyTrainingV1311DemoDashboardCustomizationConsts.Applications.Angular,
        ...
        public Dashboard GetDefaultMvcHostDashboardView()
        {
            ...
            {
                DashboardName = MyTrainingV1311DemoDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
                Pages = new List<Page>
                {
                    new Page($"Page_{MyTrainingV1311DemoDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard}_{MyTrainingV1311DemoDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
                        Name = MyTrainingV1311DemoDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = MyTrainingV1311DemoDashboardCustomizationConsts.Widgets.Host
                                    .TopStats, // Top Stats
                                Height = 6,
                                Width = 12,
                                PositionX = 0,
                            ...
                            {
                                WidgetId =
                                    MyTrainingV1311DemoDashboardCustomizationConsts.Widgets.Host
        ...
        public Dashboard GetDefaultMvcTenantDashboardView()
        {
            ...
            return new Dashboard
            {
                DashboardName = MyTrainingV1311DemoDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
                Pages = new List<Page>
                {
                    new Page($"Page_{MyTrainingV1311DemoDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard}_{MyTrainingV1311DemoDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
                        Name = MyTrainingV1311DemoDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = MyTrainingV1311DemoDashboardCustomizationConsts.Widgets.Tenant
                            ...
                            {
                                WidgetId =
                                    MyTrainingV1311DemoDashboardCustomizationConsts.Widgets.Tenant
        ...
        {
            return new LocalizableString(name, MyTrainingV1311DemoConsts.LocalizationSourceName);
        }
    }
}
