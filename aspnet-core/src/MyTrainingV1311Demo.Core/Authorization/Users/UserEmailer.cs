...
namespace MyTrainingV1311Demo.Authorization.Users
{
    ...
    /// </summary>
    public class UserEmailer : MyTrainingV1311DemoServiceBase, IUserEmailer, ITransientDependency
    {
        ...
        public async Task SendPasswordResetLinkAsync(User user, string link = null)
        {
            ...
            if (!link.IsNullOrEmpty())
            {
                ...
                var expireDate = Uri.EscapeDataString(Clock.Now.AddHours(expirationHours)
                    .ToString(MyTrainingV1311DemoConsts.DateTimeOffsetFormat, CultureInfo.InvariantCulture));
