...
using MyTrainingV1311Demo.Authorization.Users.Password;
...
using MyTrainingV1311Demo.Web.Startup.ExternalLoginInfoProviders;
...
namespace MyTrainingV1311Demo.Web.Startup
{
    ...
    public class MyTrainingV1311DemoWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public MyTrainingV1311DemoWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(MyTrainingV1311DemoWebHostModule).GetAssembly());
        }
