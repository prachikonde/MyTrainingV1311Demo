...
namespace MyTrainingV1311Demo.Core.Base
{
    public abstract class MyTrainingV1311DemoQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected MyTrainingV1311DemoQueryBase(string fieldName,
