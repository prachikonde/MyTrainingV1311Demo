...
namespace MyTrainingV1311Demo.Web.Public.Startup
{
    [DependsOn(
        typeof(MyTrainingV1311DemoWebCoreModule)
    )]
    public class MyTrainingV1311DemoWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public MyTrainingV1311DemoWebFrontEndModule(IWebHostEnvironment env, MyTrainingV1311DemoEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(MyTrainingV1311DemoWebFrontEndModule).GetAssembly());
        }
    }
}
