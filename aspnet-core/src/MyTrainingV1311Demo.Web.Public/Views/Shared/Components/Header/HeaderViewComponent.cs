...
using MyTrainingV1311Demo.Web.Public.Startup;
using MyTrainingV1311Demo.Web.Session;
using MyTrainingV1311Demo.Web.UiCustomization;

namespace MyTrainingV1311Demo.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : MyTrainingV1311DemoViewComponent
    {
