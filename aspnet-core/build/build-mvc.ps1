...
$webMvcFolder = Join-Path $slnFolder "src/MyTrainingV1311Demo.Web.Mvc"
$webPublicFolder = Join-Path $slnFolder "src/MyTrainingV1311Demo.Web.Public"
...
dotnet restore MyTrainingV1311Demo.Web.sln
