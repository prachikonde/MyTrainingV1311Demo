...
(function () {
    var showMessage = function (type, message, title, options) {
        ...
        options.icon = type;
        options.confirmButtonText = options.confirmButtonText || abp.localization.localize('Ok', 'MyTrainingV1311Demo');
    ...
    abp.message.confirm = function (message, title, callback, options) {
        options = options || {};
        options.title = title ? title : abp.localization.localize('AreYouSure', 'MyTrainingV1311Demo');
        options.icon = options.icon || 'warning';

        options.confirmButtonText = options.confirmButtonText || abp.localization.localize('Yes', 'MyTrainingV1311Demo');
        options.cancelButtonText = options.cancelButtonText || abp.localization.localize('Cancel', 'MyTrainingV1311Demo');
