...
import { MyTrainingV1311DemoCommonModule } from '@shared/common/common.module';
...
function initializeLocalForage() {
    localForage.config({
        ...
        name: 'MyTrainingV1311Demo',
        version: 1.0,
        storeName: 'abpzerotemplate_local_storage',
        description: 'Cached data for MyTrainingV1311Demo',
    });
}
...
@NgModule({
    imports: [
        ...
        AppModule,
        MyTrainingV1311DemoCommonModule.forRoot(),
        ServiceProxyModule,
        HttpClientModule,
        RootRoutingModule,
        NgxSpinnerModule,
